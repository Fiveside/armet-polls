...
DATABASES = {
    'default': {
        ...
        'NAME': path.abspath(path.join(PROJECT_ROOT, 'sqlite3.db')),
...
SECRET_KEY = '+h=kyd76s9+s9^4p)dj#!-dqh3ou+5i%!1u@$kpy48d*a0+knv'
...
MIDDLEWARE_CLASSES = (
    ...
    'polls.middleware.AllowOriginMiddleware',
)
